# Die Seelenplanerin App – TODO

## Design & Branding
- [x] App-Logo generieren (mystisch-spirituell, Mondphasen, Seelenplanerin)
- [x] Farbpalette konfigurieren (Tiefviolett, Gold, Creme, Dunkelblau)
- [x] Theme konfigurieren (dark/light mode)

## Navigation & Struktur
- [x] Tab-Navigation: Seele (Home), Entdecken, Mond, Favoriten
- [x] Icon-Mapping für alle Tabs
- [x] Splash Screen konfigurieren

## Screens
- [x] Home Screen (Tagesimpuls, Mondphase, Kategorien)
- [x] Entdecken Screen (Alle Inhalte: Rituale, Meditationen, Gedichte, Impulse)
- [x] Rituale Screen (Liste + Detailansicht)
- [x] Meditationen Screen (Liste + Detailansicht)
- [x] Gedichte Screen (Liste + Detailansicht)
- [x] Impulse Screen (Liste + Detailansicht)
- [x] Favoriten Screen
- [x] Detail Screen (Universell für alle Content-Typen)

## Features
- [x] Mondphasen-Anzeige (aktuell)
- [x] Tagesimpuls (täglich wechselnd)
- [x] Favoriten speichern (AsyncStorage)
- [x] Kategorien-Filter
- [x] Suchfunktion
- [x] Sample-Content für alle Kategorien

## Daten
- [x] Content-Daten für Rituale
- [x] Content-Daten für Meditationen
- [x] Content-Daten für Gedichte
- [x] Content-Daten für Impulse

## Logo & Foto Integration
- [x] Laras echtes Logo als App-Icon einbinden
- [x] Logo im Home-Header anzeigen
- [x] Farbpalette an echtes Branding (Gold/Creme/Braun) anpassen
- [x] Über-Lara-Screen mit Foto, Bio und Instagram-Link erstellen
- [x] Navigation um Profil/Lara-Tab erweitern

## Shop
- [x] Shop-Screen mit Produktkatalog (Räucherstäbchen, Kerzen, Heilsteine etc.)
- [x] Produkt-Detailseite
- [x] Warenkorb-Funktion
- [x] Produkt-Empfehlungen bei jedem Ritual
- [x] Externe Kaufabwicklung (Link zu Shop-URL)

## Buchung / Kalender
- [x] Buchungs-Screen für Sessions (Aura Reading, Coaching, Energiearbeit)
- [x] Kalender-Ansicht mit verfügbaren Terminen
- [x] Session-Typen mit Beschreibung und Preis
- [x] Buchungsanfrage / Weiterleitung

## Zweisprachigkeit
- [ ] Deutsch/Englisch Umschalter
- [ ] Alle Screens auf Englisch übersetzen

## Runen-System
- [x] Runen-Daten (alle 24 Elder Futhark Runen + Themen) einpflegen
- [x] Schutzrune-Rechner nach Geburtsdatum
- [x] Themen-Auswahl (Liebe, Schutz, Erfolg, Heilung, etc.)
- [x] Armband-Konfigurator (3 Charms + Armband)
- [x] Shop-Anbindung für Runen-Armbänder
...
- [ ] Passende Räucherwerk pro Mondphase
- [ ] Mondphasen-Tagebuch / Journal
- [ ] Shop-Produkte pro Mondphase

## Design-Update (Rosa, Creme, Gold)
- [x] Farbpalette auf hell, warm, feminin umstellen (dezentes Rosa, Creme, Gold)
- [x] Hintergrund: warmes Creme/Off-White statt dunkel
- [x] Akzentfarbe: sanftes Rosa + Gold
- [x] Alle Screens im neuen hellen Design aktualisieren
- [x] Tab-Bar im neuen femininen Stil
- [x] Karten und Buttons mit warmem Look

## Korrekturen & Details
- [ ] Schutzarmbänder: Stein = Schwarzer Turmalin (nicht Druzy) – alle Beschreibungen anpassen
- [ ] Runen-Plättchen: handgraviert von Lara, mit Heilstein-Pulver – in Produktbeschreibungen betonen

## Journal
- [x] Journal-Screen mit persönlichen Einträgen
- [x] Neuen Eintrag schreiben (Freitext + Datum)
- [x] Stimmungs-Auswahl (Emojis)
- [x] Einträge speichern (AsyncStorage, privat)
- [x] Einträge durchsuchen und lesen
- [x] Journal-Button auf Home Screen

## Admin-Panel (Laras Zugang)
- [x] Versteckter Admin-Bereich (Zugang über Einstellungen mit PIN)
- [x] Content verwalten: Rituale, Meditationen, Gedichte, Impulse hinzufügen/bearbeiten/löschen
- [x] Produkte verwalten: Preise, Beschreibungen, Bilder ändern
- [x] Tagesimpuls manuell setzen
- [x] Shop-Links aktualisieren (Tentary/Shopify URL)
- [x] Admin-PIN schützen

## Design-Overhaul (Persönlich, Warm, Nicht-KI)
- [x] Warme Aquarell-Hintergrundtextur generieren (Creme/Rosa)
- [x] Organische, handgemachte Formensprache (keine harten Ecken, keine sterilen Karten)
- [x] Persönliche Sprache von Lara in allen Screens ("Ich freue mich, dass du da bist...")
- [x] Handschrift-ähnliche Schriftart für Überschriften einbinden (DancingScript auf allen Screens)
- [x] Warme Farbverläufe statt flacher Farben (LinearGradient auf Begrüßung, Impuls, Premium)
- [x] Dekorative Elemente: Blüten, Mondphasen, Blätter als Illustrationen (Emojis + organische Formen)
...
## Finale Überarbeitung vor Veröffentlichung (26.02.2026)
- [x] Ich-Seite für normale Nutzer optimieren (persönlicher, nicht nur Schnellzugriff-Links)
- [x] Themen-Armbänder: Runen-Zuordnung korrekt anpassen (Schwarzer Turmalin statt Druzy)
- [x] Runen-Plättchen: "handgraviert von der Seelenplanerin, mit Heilstein-Pulver" in Produktbeschreibungen betonen
- [x] Handschrift-ähnliche Schriftart für Überschriften einbinden (DancingScript auf allen Screens)
- [x] Warme Farbverläufe statt flacher Farben (LinearGradient auf Home-Screen Karten)
...
- [x] Datenbank-Schema: Affiliate-Tabellen (referral_codes, referral_clicks, referral_sales, referral_payouts)
- [x] Server-API: Affiliate-Routen (Code generieren, Klicks tracken, Verkäufe eintragen, Provisionen berechnen)
- [x] Referral-Tracking: Landingpage mit Cookie-Tracking bei Link-Klick
- [x] App: "Geben & Nehmen" Bereich im Ich-Tab
- [x] App: Persönlicher Empfehlungslink mit Kopier- und Teilen-Button
- [x] App: Affiliate-Dashboard (Klicks, Empfehlungen, Provisionen, Auszahlungen)
...
- [x] Seelen Academy: Warteliste mit E-Mail-Eintragung
