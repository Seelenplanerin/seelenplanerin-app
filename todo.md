...
- [ ] Handschrift-ähnliche Schriftart für Überschriften einbinden
- [ ] Warme Farbverläufe statt flacher Farben
- [ ] Dekorative Elemente: Blüten, Mondphasen, Blätter als Illustrationen
...
## FEATURE: Push-Nachrichten aus Admin senden (16.04.2026)
- [x] Client: Push-Token-Registrierung beim App-Start (lib/notifications.ts erstellt)
- [x] Server: Push-Token in DB speichern (push_tokens Tabelle war bereits vorhanden)
...
- [x] Impressum-Seite erstellt (app/impressum.tsx) mit TMG-Angaben, Datenschutz, Haftungsausschluss, Urheberrecht
- [x] Impressum im Ich-Tab verlinkt unter "Rechtliches" Sektion + Datenschutzerklärung-Link
