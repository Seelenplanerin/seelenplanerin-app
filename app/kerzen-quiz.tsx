...
const HEILSTEINE: Heilstein[] = [
  ...
  },
  {
    ...
    chakra: "Wurzelchakra",
    element: "Erde & Feuer",
    themen: ["wahrheit", "schutz", "transformation", "erdung"],
    kurzBeschreibung: "Der Stein der Wahrheit und des Schutzes",
    langBeschreibung: "Obsidian ist ein kraftvoller Schutzstein, der aus vulkanischem Glas entsteht. Er hilft dir, die Wahrheit zu erkennen, blockierte Emotionen zu lösen und dich vor negativen Energien zu schützen. Er fördert Selbsterkenntnis und unterstützt tiefe Transformationsprozesse.",
    affirmation: "Ich erkenne meine Wahrheit und bin geschützt auf meinem Weg der Transformation.",
    wirkung: ["Schützt vor negativen Energien", "Fördert Selbsterkenntnis", "Löst Blockaden", "Unterstützt Transformation", "Erdet und stabilisiert"],
  },
  {
    id: "carneol",
    name: "Carneol",
