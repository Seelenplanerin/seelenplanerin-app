...
const PRODUCTS: Product[] = [
  // === RITUAL-SETS ===
  {
    ...
    preis: 29.90,
    preisDisplay: "29,90 €",
    beschreibung: "Schwarzer Turmalin, Obsidian, Weißer Salbei & schwarze Kerze – alles was du für dein Schutzritual brauchst.",
    emoji: "🛡️",
  ...
  },
  {
    ...
    preis: 29.90,
    preisDisplay: "29,90 €",
    beschreibung: "Citrin, Bergkristall, Weihrauch & goldene Kerze – manifestiere Fülle und Wohlstand in deinem Leben.",
    emoji: "✨",
    highlight: "Inkl. Versand",
  ...
  },
  {
    ...
    preis: 29.90,
    preisDisplay: "29,90 €",
    beschreibung: "Karneol, Bergkristall, Weihrauch & rote Kerze – entfache dein inneres Feuer und finde deinen Mut.",
    emoji: "🔥",
    highlight: "Inkl. Versand",
  ...
  },
  {
    ...
    preis: 29.90,
    preisDisplay: "29,90 €",
    beschreibung: "Karneol, Rosenquarz, Weihrauch & orange Kerze – bringe Freude und Energie in deinen Alltag.",
    emoji: "☀️",
    highlight: "Inkl. Versand",
  ...
  },
  {
    ...
    preis: 24.00,
    preisDisplay: "24,00 €",
    beschreibung: "Einzelner Runen-Charm, handgraviert von der Seelenplanerin, gefüllt mit echtem Heilstein-Pulver. Passend für das Silberkettenarmband.",
    emoji: "✦",
    tentaryUrl: "https://dieseelenplanerin.tentary.com/p/qnl3vN",
  },
  // === SESSIONS ===
  ...
  {
    id: "deep-talk-111",
    name: "Deep Talk – Basis",
    nameEn: "Deep Talk – Basic",
    kategorie: "sessions",
    preis: 111.00,
    preisDisplay: "111,00 €",
  ...
  {
    id: "deep-talk-222",
    name: "Deep Talk – Vertiefung",
    nameEn: "Deep Talk – Deep Dive",
    kategorie: "sessions",
    preis: 222.00,
    preisDisplay: "222,00 €",
    ...
    emoji: "💫",
    highlight: "Vertiefte Seelenarbeit",
    tentaryUrl: "https://dieseelenplanerin.tentary.com/p/Ciz1am",
  },
  {
    id: "deep-talk-444",
    name: "Deep Talk – Intensiv",
    nameEn: "Deep Talk – Intensive",
    kategorie: "sessions",
    preis: 444.00,
    preisDisplay: "444,00 €",
    ...
    emoji: "💫",
    highlight: "Intensiv-Transformation",
    tentaryUrl: "https://dieseelenplanerin.tentary.com/p/Ciz1am",
  },
  {
    id: "deep-talk-888",
    name: "Deep Talk – Premium",
    nameEn: "Deep Talk – Premium",
    kategorie: "sessions",
    preis: 888.00,
    preisDisplay: "888,00 €",
    beschreibung: "Das umfassendste Paket. Mehrere Sessions, tiefste Seelenarbeit, komplette Transformation und langfristige Begleitung durch die Seelenplanerin.",
    emoji: "💫",
    highlight: "Premium-Begleitung",
    tentaryUrl: "https://dieseelenplanerin.tentary.com/p/Ciz1am",
    badge: "Premium",
  },
  // === KERZEN ===
