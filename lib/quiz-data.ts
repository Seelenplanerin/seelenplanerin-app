...
export const SCHUTZRUNEN: Record<number, { rune: string; symbol: string; name: string; bedeutung: string; beschreibung: string }> = {
  ...
  16: { rune: "Sowilo", symbol: "ᛊ", name: "Sowilo", bedeutung: "Sieg & Lebensenergie", beschreibung: "Sowilo ist deine Schutzrune – die Rune der Sonne. Sie schützt deine Lebensenergie und führt dich immer zum Sieg." },
