...
/** Vollmond-Daten 2027 (UTC) – exakt von calendar-12.com */
const VOLLMONDE_2027_RAW = [
  new Date("2027-01-22T12:18:00Z"),  // 22. Januar  (MEZ: 13:18)
  new Date("2027-02-20T23:24:00Z"),  // 20. Februar (MEZ: 00:24 am 21.)
  new Date("2027-03-22T10:44:00Z"),  // 22. März    (MEZ: 11:44)
  new Date("2027-04-20T22:27:00Z"),  // 20. April   (MESZ: 00:27 am 21.)
  new Date("2027-05-20T10:59:00Z"),  // 20. Mai     (MESZ: 12:59)
  new Date("2027-06-19T00:45:00Z"),  // 19. Juni    (MESZ: 02:45)
  new Date("2027-07-18T15:46:00Z"),  // 18. Juli    (MESZ: 17:46)
  new Date("2027-08-17T07:30:00Z"),  // 17. August  (MESZ: 09:30)
  new Date("2027-09-15T23:05:00Z"),  // 15. Sept.   (MESZ: 01:05 am 16.)
  new Date("2027-10-15T13:48:00Z"),  // 15. Oktober (MESZ: 15:48)
  new Date("2027-11-14T03:27:00Z"),  // 14. Nov.    (MEZ: 04:27)
  new Date("2027-12-13T16:10:00Z"),  // 13. Dez.    (MEZ: 17:10)
];

const VOLLMONDE_2026 = [...VOLLMONDE_2026_RAW, ...VOLLMONDE_2027_RAW];

/** Neumond-Daten 2026 (UTC) – exakt von timeanddate.com */
const NEUMONDE_2026_RAW = [
...
/** Neumond-Daten 2027 (UTC) – exakt von calendar-12.com */
const NEUMONDE_2027_RAW = [
  new Date("2027-01-07T20:25:00Z"),  // 7. Januar
  new Date("2027-02-06T15:57:00Z"),  // 6. Februar
  new Date("2027-03-08T09:31:00Z"),  // 8. März
  new Date("2027-04-06T23:53:00Z"),  // 6. April
  new Date("2027-05-06T11:00:00Z"),  // 6. Mai
  new Date("2027-06-04T19:41:00Z"),  // 4. Juni
  new Date("2027-07-04T03:03:00Z"),  // 4. Juli
  new Date("2027-08-02T10:06:00Z"),  // 2. August
  new Date("2027-08-31T17:42:00Z"),  // 31. August
  new Date("2027-09-30T02:36:00Z"),  // 30. September
  new Date("2027-10-29T13:36:00Z"),  // 29. Oktober
  new Date("2027-11-28T03:25:00Z"),  // 28. November
  new Date("2027-12-27T20:13:00Z"),  // 27. Dezember
];

const NEUMONDE_2026 = [...NEUMONDE_2026_RAW, ...NEUMONDE_2027_RAW];

/** Erstes Viertel 2026 (UTC) */
const ERSTES_VIERTEL_2026_RAW = [
...
/** Erstes Viertel 2027 (UTC) */
const ERSTES_VIERTEL_2027_RAW = [
  new Date("2027-01-15T20:34:00Z"),
  new Date("2027-02-14T07:58:00Z"),
  new Date("2027-03-15T16:25:00Z"),
  new Date("2027-04-13T22:57:00Z"),
  new Date("2027-05-13T04:44:00Z"),
  new Date("2027-06-11T10:57:00Z"),
  new Date("2027-07-10T18:40:00Z"),
  new Date("2027-08-09T04:55:00Z"),
  new Date("2027-09-07T18:31:00Z"),
  new Date("2027-10-07T11:47:00Z"),
  new Date("2027-11-06T07:59:00Z"),
  new Date("2027-12-06T05:22:00Z"),
];

const ERSTES_VIERTEL_2026 = [...ERSTES_VIERTEL_2026_RAW, ...ERSTES_VIERTEL_2027_RAW];

/** Letztes Viertel 2026 (UTC) */
const LETZTES_VIERTEL_2026_RAW = [
...
/** Letztes Viertel 2027 (UTC) */
const LETZTES_VIERTEL_2027_RAW = [
  new Date("2027-01-29T10:56:00Z"),
  new Date("2027-02-28T05:18:00Z"),
  new Date("2027-03-30T00:56:00Z"),
  new Date("2027-04-28T20:20:00Z"),
  new Date("2027-05-28T13:59:00Z"),
  new Date("2027-06-27T04:56:00Z"),
  new Date("2027-07-26T16:56:00Z"),
  new Date("2027-08-25T02:28:00Z"),
  new Date("2027-09-23T10:21:00Z"),
  new Date("2027-10-22T17:30:00Z"),
  new Date("2027-11-21T00:50:00Z"),
  new Date("2027-12-20T09:13:00Z"),
];

const LETZTES_VIERTEL_2026 = [...LETZTES_VIERTEL_2026_RAW, ...LETZTES_VIERTEL_2027_RAW];
